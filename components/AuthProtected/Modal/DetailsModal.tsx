            ...
            <div className="p-8 pt-4 overflow-y-auto scrollbar-hide space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(data).map(([key, value]) => {
                  if (
                    subscriptionFields.includes(key) ||
                    key === "Name" ||
                    key === "Email" ||
                    key === "avatar" ||
                    key === "id"
                  ...
                  return (
                    <div
                      key={key}
                      className="p-4 rounded-2xl bg-slate-50/50 border border-slate-100/50 space-y-1.5"
                    >
                      ...
                      <div className="font-bold text-slate-700 truncate capitalize">
                        {String(value)}
                      </div>
                    </div>
                  );
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={cn(
                      ...
                      data["Subscription Status"] === "monthly" ||
                        data["Subscription Status"] === "yearly"
